...
AS $$
  SELECT CASE
    ...
    WHEN shareholders !~ '[ァ-ヴー]{3}|[Ａ-Ｚａ-ｚ]|株式会社|有限会社|合同会社|合資会社|持株会|組合|信用金庫|社団法人|財団法人|協会|公社|機構|工業|産業|商事|物流|運輸|建設|製作所|ホールディングス|グループ|不動産|電気|電機|化学|製薬|食品|印刷|通運|海運|倉庫|鉄道|電力|証券|保険|銀行|金属|鋼|セメント|紡績|繊維|石油|投資育成|自動車|百貨店|機械|製造|事務所|研究所|水産|薬品|塗料|樹脂|興業|販売|醸造|鋳造|・|物産|商会|商店|実業|企画|開発|設計|観光|交通|汽船|航空|放送|通信|情報|土木|住宅|地所|事業|管理|配送|急便|酒造|乳業|木材|園芸|養殖|都市|鋼管|電線|測量|学園|新聞|牧場|農園|薬局|書店|出資|合名|内装|家具|飼料|肥料|油脂|光学|精密|計器|硬質|鍛造'
      THEN 'individual'
    WHEN EXISTS (
