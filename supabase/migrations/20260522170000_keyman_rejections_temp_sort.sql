-- =====================================================================
-- キーマン断り一覧に「温度感」ソート (temp_desc / temp_asc) を追加
--   HIGH=3, MEDIUM=2, LOW=1, 未判定=0 で並べ替え
--   二次キー: days_since_reject asc（同じ温度感なら最近の断りを上に）
-- 対象: smart_queue_keyman_rejections / smart_queue_keyman_rejections_ids
--       （p_engagement_ids 受け取り版のみ更新。 旧オーバーロードは未使用）
-- =====================================================================
