...
const FALLBACK_BODY: Record<string, string> = {
  ...
  kickoff_hearing_published:
    '{customer_name}様\n\nスパキャリへのお申し込みありがとうございます。\n第1回セッションを最大限有意義な時間にするため、事前ヒアリング（全70問・所要60〜90分）にご記入をお願いいたします。\n\n【回答ページ】\n{hearing_url}\n\n【提出期限】\n{deadline} まで（第1回セッションの3日前 23:59）\n\n回答は途中保存できます。お時間を確保のうえ、必ず期限内のご提出をお願いいたします。',
  kickoff_hearing_reminder:
    '{customer_name}様\n\nキックオフヒアリングの提出期限まで残り24時間となりました。\n（期限：{deadline}）\n\n【回答ページ】\n{hearing_url}\n\n途中保存しているものがあれば、引き続きご記入をお願いいたします。',
}
