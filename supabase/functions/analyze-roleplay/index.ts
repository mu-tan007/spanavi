...
${transcript}`
    ...
    // Slack 通知は DB trigger (notify_slack_on_roleplay_done) が
    // ai_status='done' 遷移を検知して pg_net 経由で post-roleplay-to-slack を発火。
    // Edge Function の background task 終端で打ち切られても通知が落ちないようにするため。
