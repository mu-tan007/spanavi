...
const RULES = [
  ...
  },
  {
    no: 3,
    title: '毎朝、目標を声に出せ',
    body: '「言霊」という言葉がある通り、口に出すことで思考は現実に近づく。篠宮が尊敬するM&AキャピタルパートナーズのOキーマンは、創業当初から毎朝「M&Aキャピタルパートナーズを世界最高峰の投資銀行にする」と口にしている。毎朝、自分の目標と目的を声に出せ。そこから逆算して「今日何をすべきか」が明確になる。',
  },
  {
    no: 4,
    title: 'M&Aの社会的意義を理解せよ',
    body: '日本全国の中小企業は約336万社。そのうち約半数が後継者未定。キーマンの平均年齢はおよそ60歳。このまま何も手を打たなければ、向こう10年で約100万社が後継者問題を主因に消滅しかねない。中小企業は日本のGDPの付加価値額ベースで半数以上を占める。その消滅は国力の衰退を意味する。俺たちの営業は、それを食い止める仕事だ。この事実を腹の底から理解しろ。',
  },
  {
    no: 5,
    title: '断られても一切気にするな',
    body: '中小企業のキーマンの中には、M&Aに対して「乗っ取り」「ハゲタカ」というイメージを持っている人がまだ多い。「二度とかけてくるな」と罵倒されることもあるだろう。だが、M&Aの提案を聞く必要がない会社など一社もない。後継者がいると思い込んでいるキーマンでも、息子が本当に継ぐかは本人にしか分からない。承継が実現しなければ、従業員も取引先も全員が路頭に迷う。俺たちの提案は、それを防ぐためにある。断りの言葉は、相手の無知であって、お前の価値の否定ではない。',
  },
  {
    no: 6,
    title: '圧倒的な自信を持って架電せよ',
    body: '自信のない営業から提案を受けても、キーマンの気持ちは1ミリも動かない。「アポが取れたら数万円入るからお願いします」——そんな下心が滲む話しぶりでは絶対に取れない。正しい心持ちはこうだ。「キーマン、この話を聞かないと絶対に損ですよ。御社の将来にとってM&Aは切っても切り離せない選択肢です。この30分の提案を聞かないと、将来本当に損しますよ。いいんですか、キーマン?」——この気迫で挑め。',
  },
  {
    no: 7,
    title: '「何を話すか」より「どう話すか」',
    body: 'テレアポは3〜4分の勝負だ。30分〜1時間かける対面商談とは違う。中小企業のオーナーキーマンは、現場叩き上げで成り上がった人が多い。そんな相手に短時間で合理的な説明を冷静にしても響かない。大事なのは「こいつはイケてるな、ちょっと面白い提案をしてくれそうだから話くらい聞いてやるか」と思わせること。話の中身よりも、話しぶりで勝負しろ。',
  },
  {
    no: 8,
    title: '断られた時こそ余裕を見せろ',
    body: '「M&Aなんて興味ないよ」と言われた瞬間にたじろぐな。断られた時こそどっしりと構え、まずキーマンの言葉に寄り添え。その上で、再度メリットをパッションを込めて提示し、そのままの流れで日程調整に持ち込む。この一連の流れを自然にやれるようになれば、アポイントは必ず取れる。焦りはキーマンに見透かされる。余裕こそが最強の武器だ。',
  },
  {
    no: 9,
    title: 'キーマンの時間を1秒たりとも無駄にするな',
    body: '中小企業のキーマンはとてつもなく忙しい。そんなキーマンの貴重な数分間を奪っている自覚を持て。自信のない話しぶりでキーマンに「なんだこいつ、俺の時間を無駄にしやがって」と思わせることは、営業として最大の失礼だ。数ある電話営業の中で「こいつと話して良かった」と思わせろ。死んでもキーマンの時間を無駄にするな。',
  },
  {
    no: 10,
  ...
  },
  {
    ...
    body: '結果を出すための最短ルートは、すでに結果を出している人間に聞くことだ。代表の篠宮でも、チームリーダーでも、売上を上げている仲間でも、とにかく質問しまくれ。ただし「教えてください」だけではダメだ。「キーマンにこう言われて、自分はこう返したけどアポに至らなかった。○○さんならどう返しますか?」——必ず自分の仮説を持った上で聞け。聞いて、取り入れて、即実行。このサイクルを誰よりも速く、大量に回した人間が勝つ。',
  },
  {
    no: 14,
    title: '報連相は"即"が鉄則',
  ...
  },
  {
    ...
    body: '既存の道がなければ、自分で作ればいい。篠宮は大学4年の時、新卒採用の実績が一度もなかったM&Aキャピタルパートナーズにどうしても入りたかった。採用窓口すらない。ならば最高意思決定権者に直接会えばいいと考え、Oキーマンが会食をする店を突き止め、1ヶ月半張り込んだ。そして会食後に直接声をかけ、その場で人事部長につないでもらい、新卒第1号として内定を勝ち取った。「恥ずかしい」「面倒くさい」は捨てろ。倫理に即した上で、目的達成のためには一切の手段を厭うな。',
  },
  {
    no: 17,
  ...
  },
  {
    ...
    body: '学生のうちから何百回、何千回と中小企業のキーマンに営業をかける経験は、サークルやバイトでは絶対に手に入らない。篠宮自身、大学4年で何千回とキーマンを口説き続けた結果、20代前半で海千山千のオーナーキーマンと対等に話せるようになった。就職後の対面営業でも全く物怖じしない胆力は、このテレアポ経験から生まれた。MASPを卒業する頃には、圧倒的なコミュニケーション能力が身についているはずだ。その未来を信じて架電しろ。',
  },
  {
    no: 21,
    title: '規則正しい生活を徹底せよ',
