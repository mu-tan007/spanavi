...
export default function CompanySearchView({ importedCSVs, callListData, setCallingScreen, setImportedCSVs, clientData = [], currentUser, members = [], setCallFlowScreen, rewardMaster = [] }) {
  ...
  return (
    <div style={{ animation: "fadeIn 0.3s ease" }}>
      {/* ページヘッダー */}
      <div style={{ marginBottom: 24, paddingBottom: 14, borderBottom: '1px solid #0D2247', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
        <div>
...
function TsrIndustryModal({ onClose }) {
