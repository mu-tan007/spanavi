      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', background: "#fff", borderRadius: 4, border: '1px solid #E5E7EB' }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto' }}>
          {sorted.length === 0 ? (
            ...
            <>
              <div style={{ display: 'grid', gridTemplateColumns: '78px 250px 120px 100px 110px 110px 110px 1fr', padding: '8px 14px', background: '#0D2247', borderBottom: '1px solid #E5E7EB', borderLeft: '3px solid transparent', fontSize: 11, fontWeight: 600, color: '#fff', verticalAlign: 'middle', flexShrink: 0 }}>
              ...
              {sorted.map((item, i) => {
                ...
                return (
                  <div key={i} onClick={() => {
                    ...
                    style={{ display: 'grid', gridTemplateColumns: '78px 250px 120px 100px 110px 110px 110px 1fr', padding: '8px 14px', fontSize: 11, alignItems: 'center', borderBottom: '1px solid #E5E7EB', borderLeft: '3px solid transparent', background: past ? '#fff5f5' : i % 2 === 0 ? '#fff' : '#F8F9FA', cursor: 'pointer' }}
