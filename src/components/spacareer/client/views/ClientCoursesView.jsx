...
export default function ClientCoursesView() {
  return (
    <div style={{ padding: space[4] }}>
      <h1 style={{ fontSize: font.size.xl, fontWeight: font.weight.bold, color: color.navy, marginBottom: space[2] }}>AI講座</h1>
      <p style={{ fontSize: font.size.sm, color: color.textMid, marginBottom: space[4] }}>あなた専用に用意された講座動画です。スキマ時間に学習を進めていきましょう。</p>
