...
const AUTO_MAP = {
  ...
  '売上千円': 'revenue_k', '売上（千円）': 'revenue_k',
  '当期純利益': 'net_income_k', '純利益': 'net_income_k', '当期純利益(千円)': 'net_income_k',
  '当期純利益（千円）': 'net_income_k',
  '経常利益': 'ordinary_income_k', '経常利益(千円)': 'ordinary_income_k', '経常利益（千円）': 'ordinary_income_k',
  '資本金': 'capital_k', '資本金(単位:千円)': 'capital_k', '資本金(千円)': 'capital_k',
  '資本金（千円）': 'capital_k',
